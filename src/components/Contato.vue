<template>
  <h1 class="text-center" id="contato">Entre em contato conosco!</h1>
  <div class="container">
    ...
    <div class="input-group mb-3">
      <span class="input-group-text tel" id="basic-addon1">Telefone</span>
      <input
        type="tel"
        class="form-control"
    ...
    <div class="input-group mb-3">
      ...
      <select name="paises" class="form-select">
    ...
    <div class="input-group">
      <span class="input-group-text"
        ...
        mensagem</span
      >
      <textarea class="form-control message" aria-label="Mensagem"></textarea>
    </div>
    <div class="form-check form-switch">
      ...
      <label class="form-check-label" for="flexSwitchCheckDefault"
        >&nbsp;Eu concordo com a Política de Privacidade.</label
      >
    </div>
  </div>
  <div class="container">
    <button
      class="btn"
      v-on:click="
        say('Obrigado por sua mensagem! Responderemos o mais breve possível.')
      "
    >
      Enviar
    </button>
